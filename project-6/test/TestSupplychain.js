...
contract("SupplyChain", function (accounts) {
  ...
  // 1st Test
  it("Testing the smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    const supplyChain = await SupplyChain.deployed();

    // Assign the Farmer Role to the Farmer's Address
    await supplyChain.addFarmer(originFarmerID, { from: ownerID });

    // Declare and Initialize a variable for the event
    ...
    // Mark an item as Harvested by calling the function harvestItem()
  ...
  // 2nd Test
  it("Testing the smart contract function processItem() that allows a farmer to process coffee", async () => {
    const supplyChain = await SupplyChain.deployed();
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    assert.equal(resultBufferTwo[5], 3, "Error: Invalid item State1");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    // Assign the Distributor Role to the Distributor's Address
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    ...
    // Assign the Retailer Role to the Retailer's Address
  ...
  it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
    ...
    // Assign the Consumer Role to the Consumer's Address
    ...
    assert.equal(
      resultBufferTwo[7],
      retailerID,
      "Error: Invalid Retailer Address"
    );
    assert.equal(
      resultBufferTwo[8],
      consumerID,
